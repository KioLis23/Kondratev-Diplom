...
def detect_anomalies():
    ...
    if file_path:
        ...
        anomalies_data = pd.DataFrame({
            ...
            'source_ip': ip_label_encoders['source_ip'].inverse_transform(new_data['source_ip_encoded']),
            'destination_ip': ip_label_encoders['destination_ip'].inverse_transform(new_data['destination_ip_encoded']),
            'source_port': new_data['source_port'],
            'destination_port': new_data['destination_port'],
            'protocol': protocol_label_encoder.inverse_transform(new_data['protocol_encoded']),
            'packet_size': new_data['packet_size'],
            'MSE': mse
        })
